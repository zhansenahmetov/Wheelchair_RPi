...
#         self._pressure_oversample = 0b101
#         self._temp_oversample = 0b101
#         self._humidity_oversample = 0b101
#         self._filter = 0b010
...
class Adafruit_BME680_I2C(Adafruit_BME680):
    ...
    def __init__(self, i2c, address=0x76, debug=False, *, refresh_rate=0.2):
